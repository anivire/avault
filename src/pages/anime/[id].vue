<template>
    ...
    <div v-else class="flex flex-row mx-auto max-w-7xl p-5 w-full items-center justify-center h-[50rem]">
        <p class=" bg-zinc-900/50 w-fit h-fit px-10 py-2 rounded-md border-2 border-zinc-800/50 text-sm flex flex-row gap-3 items-center"><Icon name="ri:loader-5-line" class="animate-spin"></Icon>Anime is loading</p>
    </div>
</template>
